...
getResource($path, $resource='Resource')</span>

<div class="function">
<pre>
$coll = BigCommerce_Api::getResource("/customers/1");
pre_print_r($coll);
</pre>
</div>
...
<div class="function">
<pre>
$coll = BigCommerce_Api::getResource("/customers/count");
pre_print_r($coll);
</pre>
</div>
...
<div class="function">
<pre>
$coll = BigCommerce_Api::getResource("/<?php echo $r; ?>");
pre_print_r($coll);
</pre>
</div>
...
<?php
$coll = BigCommerce_Api::getResource("/$r");
pre_print_r($coll);
?>
</div>
<?php } ?>
